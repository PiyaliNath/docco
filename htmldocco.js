...
(function() {
  ...
  parse = function(source, code, config) {
    ...
    save();}
       ...
       var pattern = lang.symbol + '[^>]*' + lang.endSymbol;
    var re = new RegExp(pattern,'g');
    lines = code.split(re);
    var comments = code.match(re);
    comments.unshift("");
    for (i = _i = 0, _len = lines.length; _i < _len; i = ++_i) {
        line = lines[i];
        codeText += line + '\n';
        if(comments[i]!=undefined){
          docsText = formatComments(comments[i],lang);
      }
      save();
    }
  }
  ...
  var formatComments =function(commentString,lang){
    var formattedComment;
    formattedComment = commentString.replace(lang.symbol,'').replace(lang.endSymbol,"").trim().replace("\n","");
